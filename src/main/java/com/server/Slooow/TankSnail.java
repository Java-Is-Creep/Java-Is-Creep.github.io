...
public class TankSnail extends SnailInGame {
	...
	public final static float MAXVELOCITYY = 6.5f;
	...
	public final static float STAMINAWALLLOSE = 2;
	// Tarda 2 segundos en recargar la stamina
	public final static float STAMINANORMALRECOVER = 2.0f;
	// Tarda 3.33 segundos en recargar la stamina
	public final static float STAMINARUNOUTRECOVER = 4.0f;
	public final static float MAXGRAVITYSPEED = -10;
	public final static float MASS = 3;
